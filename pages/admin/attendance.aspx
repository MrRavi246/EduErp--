            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar bg-white border-end p-3">
                    ...
                    <nav class="nav flex-column">
                        <a class="nav-link text-dark" href="dashboard.html"><i class="fas fa-home me-2 text-primary"></i>Dashboard </a><a class="nav-link text-dark" href="students.html"><i class="fas fa-users me-2 text-primary"></i>Students </a><a class="nav-link text-dark" href="faculty.html"><i class="fas fa-chalkboard-teacher me-2 text-primary"></i>Faculty </a><a class="nav-link text-dark" href="courses.html"><i class="fas fa-book me-2 text-primary"></i>Courses </a><a class="nav-link text-dark" href="timetable.html"><i class="fas fa-calendar me-2 text-primary"></i>Timetable </a><a class="nav-link active bg-primary text-white rounded" href="attendance.html"><i class="fas fa-calendar-check me-2"></i>Attendance </a><a class="nav-link text-dark" href="exams.html"><i class="fas fa-file-alt me-2 text-primary"></i>Exams & Results </a><a class="nav-link text-dark" href="fees.html"><i class="fas fa-money-bill-wave me-2 text-primary"></i>Fees </a><a class="nav-link text-dark" href="notices.html">
                            <i class="fas fa-bullhorn me-2 text-primary"></i>Notice Board </a><a class="nav-link text-dark" href="reports.html"><i class="fas fa-chart-bar me-2 text-primary"></i>Reports </a><a class="nav-link text-dark" href="settings.html"><i class="fas fa-cog me-2 text-primary"></i>Settings </a><a class="nav-link text-dark" href="profile.html"><i class="fas fa-user me-2 text-primary"></i>Profile </a>
                    </nav>
                </div>
            </div>
